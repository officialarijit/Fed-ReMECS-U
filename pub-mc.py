...
for jj in range(0,videos): #Video loop for each participants
    ...
    while not qLS.empty():
        ...
        #=========================================================
        # Exponential Moving Weihted Average approach (Proposed)
        #=========================================================
        global_weights = weight_sum(emwa_model_weights_scaling(global_weights,beta),emwa_model_weights_scaling(model_weights,1-beta)) #Simple Averaging in Local Clients
...
#===============================================================================
folderPath = '/home/gp/Desktop/MER_arin/FL-mqtt/Fed-ReMECS-UPDATED-2022/Final_results_U_2022/'
